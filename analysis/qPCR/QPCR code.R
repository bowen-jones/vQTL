...
test_hyb <-read.cross(file = "data/hybred.csv")
test_inbr <-read.cross(file = "data/inbred.csv")
test_full <- read.cross(file = "data/Fullinb&hyb.csv")
