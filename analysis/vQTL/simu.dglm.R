                          ...
                          ran.seed=12345)
{
  ...
  ### or, would a gene structure(a composition of mutiple A's and B'???s from gene loci) be an important thing to consider, or just with gene loci is contributing to the pynotype?
  inter.mat<-NULL;
