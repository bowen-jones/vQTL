...
####################################NOVEMBER#####################################################################
plate.1 = read.csv("./data/2018_11/2018_11_1_plate.csv")
plate.2 = read.csv("./data/2018_11/2018_11_2_plate.csv")
...
fc.6.total<- fc.6.total %>% mutate_if(is.factor,as.character)
fc.6.total<- fc.6.total %>% mutate_if(is.character,as.numeric)
...
plate.3 = read.csv("./data/2018_8/2018_8_1_plate.csv")
plate.4 = read.csv("./data/2018_8/2018_8_2_plate.csv")
plate.5 = read.csv("./data/2018_8/2018_8_3_plate.csv")
...
plate.6 = read.csv("./data/2018_6/2018_6_1_plate.csv")
#read in Junes files
plate  = plate.6
finalcycle3 = rbind(plate[2,],plate[1,],plate[3,],plate[6:45,])
sampleid = finalcycle3[1:3,]
...
exp_data_11[48,1] <- 1328 #Prevent duplicate label in final exp_data
...
names(fulldata.vqtl) = names(hybrid.inbred)
